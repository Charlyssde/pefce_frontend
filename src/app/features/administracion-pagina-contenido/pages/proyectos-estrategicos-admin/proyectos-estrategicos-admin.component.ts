...
@Component({
  selector: 'app-proyectos-estrategicos-admin',
  templateUrl: './proyectos-estrategicos-admin.component.html',
  styleUrls: ['./proyectos-estrategicos-admin.component.css']
})
export class ProyectosEstrategicosAdminComponent implements OnInit {
  ...
  getContent() {
    this.haService.getContent('proyectosEstrategicos').subscribe((resp) => {
      if (resp) {
  ...
  uploadFile(key: string) {
    ...
    let
      ...
      headers = new Headers(),
      strPath = 'portal/proyectosEstrategicos/imagenes/' + key + '.'+extension;
  ...
  uploadVideo(key: string) {
    ...
    let
      ...
      formData: FormData = new FormData(),
      headers = new Headers(),
      strPath = 'portal/proyectosEstrategicos/videos/' + key + '.'+extension;
  ...
  saveData(section: string) {
    ...
    this.haService.updateContent('proyectosEstrategicos', params).subscribe((resp) => {
      this.appC.cargando = false;
