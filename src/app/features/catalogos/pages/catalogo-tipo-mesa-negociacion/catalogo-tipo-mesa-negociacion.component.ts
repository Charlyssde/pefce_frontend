...
@Component({
  selector: 'app-catalogo-tipo-mesa-negociacion',
  templateUrl: './catalogo-tipo-mesa-negociacion.component.html',
  styleUrls: ['./catalogo-tipo-mesa-negociacion.component.css']
})
export class CatalogoTipoMesaNegociacionComponent implements OnInit {
  ...
  tableSettings: any = {
    "headers": [
      { "label" : "Tipo de mesa de negociación", "key" : "nombre" }
    ],
    "actions": true,
    "type": "TIPO DE MESA DE NEGOCIACIÓN"
  };
  helpsSettings: any = {
    'module_name': 'Catálogo de tipos de mesa de negociación',
    'description': 'Módulo encargado de gestionar los datos base relacionados a los tipos de mesa de negociación',
    'details': [
  ...
  tipoCatalogo = 'TIPO_MESA_NEGOCIACION';
