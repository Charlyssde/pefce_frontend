...
@Component({
  selector: 'app-catalogo-sectores',
  templateUrl: './catalogo-sectores.component.html',
  styleUrls: ['./catalogo-sectores.component.css']
})
export class CatalogoSectoresComponent implements OnInit {

  hasChildren: any = { 'status' : true, 'url' : '/catalogos/sectores/{padreId}/subsectores' };
  pageRequestParams: PageRequestParams = new PageRequestParams();
  pageDataset: PageModel;
  tableSettings: any = {
    "headers": [
      { "label" : "Sector", "key" : "nombre" }
    ],
    "actions": true,
    "type": "SECTORES"
  };
  helpsSettings: any = {
    'module_name': 'Catálogo de sectores',
    'description': 'Módulo encargado de gestionar los datos base relacionados a los sectores',
    'details': [
      ...
      { 'detail': 'Ver subcategoría (<span class="material-symbols-outlined">account_tree</span>)' , 'description' : 'Ir a la subcategoría del registro' }
    ]
  };
  tipoCatalogo = 'SECTORES';
