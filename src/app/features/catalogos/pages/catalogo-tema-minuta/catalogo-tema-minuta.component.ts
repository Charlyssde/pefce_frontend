...
@Component({
  selector: 'app-catalogo-tema-minuta',
  templateUrl: './catalogo-tema-minuta.component.html',
  styleUrls: ['./catalogo-tema-minuta.component.css']
})
export class CatalogoTemaMinutaComponent implements OnInit {
  hasChildren: any = { 'status' : false, 'url' : null };
  pageRequestParams: PageRequestParams = new PageRequestParams();
  pageDataset: PageModel;
  tableSettings: any = {
    "headers": [
      { "label" : "Tema de minuta", "key" : "nombre" }
    ],
    "actions": true,
    "type": "TEMA DE MINUTA"
  };
  helpsSettings: any = {
    'module_name': 'Catálogo de temas de minuta',
    'description': 'Módulo encargado de gestionar los datos base relacionados a los temas de minuta',
    'details': [
