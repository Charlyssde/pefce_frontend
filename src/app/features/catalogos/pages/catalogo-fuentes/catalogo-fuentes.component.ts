...
@Component({
  selector: 'app-catalogo-fuentes',
  templateUrl: './catalogo-fuentes.component.html',
  styleUrls: ['./catalogo-fuentes.component.css']
})
export class CatalogoFuentesComponent implements OnInit {
  ...
  tableSettings: any = {
    "headers": [
      { "label" : "Fuente de financiamiento", "key" : "nombre" }
    ],
    "actions": true,
    "type": "FUENTES DE FINANCIAMIENTO"
  };
  helpsSettings: any = {
    'module_name': 'Catálogo de fuentes de financiamiento',
    'description': 'Módulo encargado de gestionar los datos base relacionados a las fuentes de financiamiento',
    'details': [
