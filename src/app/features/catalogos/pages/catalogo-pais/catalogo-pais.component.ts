...
@Component({
  selector: 'app-catalogo-pais',
  templateUrl: './catalogo-pais.component.html',
  styleUrls: ['./catalogo-pais.component.css']
})
export class CatalogoPaisComponent implements OnInit {
  ...
  tableSettings: any = {
    "headers": [
      { "label" : "País", "key" : "nombre" }
    ],
    "actions": true,
    "type": "PAIS"
  };
  helpsSettings: any = {
    'module_name': 'Catálogo de paises',
    'description': 'Módulo encargado de gestionar los datos base relacionados a los paises',
    'details': [
